...
<head>
  ...
  <link rel="icon" href="images/jobs.ico" />
  ...
  <title>YourJobs | Find PHP Laravel Jobs & Projects</title>
</head>

<body class="mb-48">
  <nav class="flex justify-between items-center mb-4">
    <a href="/"><img class="w-24" src="{{asset('images/YourJobs.png')}}" alt="" class="logo" /></a>
